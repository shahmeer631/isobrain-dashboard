import { ICouponResponse, ICouponsResponse, ICreateCouponRequest, IUpdateCouponRequest } from "@/types/couponTypes";
...
export const couponApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    updateCoupon: builder.mutation<ICouponResponse, { id: string; body: IUpdateCouponRequest }>({
      query: ({ id, body }) => ({
        url: `/coupons/${id}`,
        method: "PATCH",
        body,
